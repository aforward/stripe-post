defmodule StripePost.Response do
  @moduledoc """
  ...
  ## Example
      ...
      iex> StripePost.Response.normalize({:ok, %{body: "{\\"answer\\": 42}", status_code: 200, headers: [{"Content-Type", "application/json"}]}})
      {200, "{\\"answer\\": 42}", [{"Content-Type", "application/json"}]}

      iex> StripePost.Response.normalize({:error, %{reason: :nxdomain}})
      {:error, :nxdomain, []}
